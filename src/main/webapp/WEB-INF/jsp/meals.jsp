...
<section>
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-info" onclick="filter()"><spring:message code="meal.filter"/></button>
        <button type="button" class="btn btn-info" onclick="clearFilter()"><spring:message code="meal.reset"/></button>
        </form>
    </div>
